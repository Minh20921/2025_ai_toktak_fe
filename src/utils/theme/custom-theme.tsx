const customTheme = {
  ...
  table: {
    ...
    head: {
      base: 'group/head text-sm font-medium capitalize text-dark dark:text-white border-b',
      cell: {
  ...
  sidebar: {
    root: {
      inner: 'bg-white dark:bg-darkgray rounded-none h-full',
    },
    item: {
      base: 'flex items-center justify-center rounded-[6px] px-[20px] py-2 mb-1 gap-3  text-[15px] text-start  leading-[normal] font-normal text-link hover:bg-lightprimary hover:text-primary dark:text-white  dark:hover:text-primary',
      content: {
    ...
    itemGroup: {
      base: '!mt-[150px] flex flex-col sm:gap-[20px] justify-start first:mt-0 first:border-t-0 first:pt-0 sidebar-nav ',
    },
  },
};
