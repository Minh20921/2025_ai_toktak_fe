...
const PackageFree = () => {
  return (
    ...
    >
      ...
      <div className="flex flex-col items-start p-10 w-full text-[#6A6A6A]">
        <h2 className="font-bold text-2xl leading-[29px] group-hover:text-[#272727]">무료</h2>
  ...
  group-hover:text-white group-hover:scale-[1.03]"
        ...
        <div className="mt-10">
          <PricingFeature>
            <span>콘텐츠 생성</span>
            <span className="font-bold"> 15개</span>
            <span>/월</span>
            <br></br>
            <span>(상품 5개×영상/이미지/블로그)</span>
          </PricingFeature>
        </div>
        ...
        <div className="mt-2">
          <PricingFeature>
            <span>콘텐츠 다운로드</span>
            <span className="font-bold"> 신규 가입 후 3일간</span>무제한 가능
          </PricingFeature>
        </div>
