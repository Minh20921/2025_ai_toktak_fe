...
export default function ThreadsVideo({ data, open, onClose, type }: FacebookProps) {
    ...
    <>
      ...
      <Modal open={open} onClose={onClose} aria-labelledby="facebook-instagram-modal">
        <Box className="absolute inset-0">
          {/* Close Button */}
          <IconButton className="sm:absolute top-2 right-2" onClick={onClose}>
            <CloseIcon />
          </IconButton>
          <Box className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-[892px] h-dvh sm:h-[800px] bg-white shadow-lg overflow-hidden">
            ...
            <div className="relative flex flex-col flex-1 py-4 h-[calc(100vh-70px)] sm:h-[calc(100%-70px)] overflow-y-scroll">
              {/* <Divider
                color="#EEEEEE"
                className="sm:hidden h-[3px] w-[70vh] mt-6 border-[#F1F1F1] rotate-90 absolute top-[330px] -left-[235px]"
              /> */}
              ...
              <div className="flex flex-col">
                <div className="flex items-start justify-between px-5 sm:px-30">
                  <div className="flex items-start gap-2.5">
                    ...
                    <div className="flex flex-col pt-3 sm:pt-0">
              ...
              {/* Media Content */}
              <div className="w-full h-[316px] sm:h-[500px] relative mt-30 pl-[70px] sm:pl-[80px]">
                <Box className="relative w-fit h-full gap-[23.11px]">
                  {data?.video_url ? (
                    <Box className="relative w-[282px] h-full flex-none">
                      <video
                        controls={false}
                        playsInline
                        autoPlay
                        ...
                        className="absolute inset-0 rounded-[10px] w-full h-full object-cover"
                      >
