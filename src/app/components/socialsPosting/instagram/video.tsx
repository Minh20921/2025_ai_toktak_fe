...
export default function InstagramVideo({ data, open, onClose, type }: FacebookProps) {
    ...
    <>
      ...
      <Modal open={open} onClose={onClose} aria-labelledby="facebook-instagram-modal">
        <Box className="absolute inset-0">
          ...
          <Box className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-[974px] bg-white shadow-lg overflow-hidden">
            <div className="flex flex-col sm:flex-row items-stretch !h-dvh sm:h-[90vh]">
              ...
              {/* Media Content */}
              <div className="w-full sm:w-[450px] bg-[#090909] relative">
                <Box className="relative w-full mx-auto h-[50vh] sm:h-full gap-[23.11px]">
                  {data?.video_url ? (
              ...
              <div className="sm:w-[524px] flex-col relative">
                ...
                <Box className="flex items-start justify-start gap-3 py-2.5 px-4">
                  <div className="hidden relative flex-none sm:inline-flex w-11 h-11">
                    {/* Gradient border */}
                    <div className="absolute inset-0 rounded-full bg-gradient-to-r from-pink-500 via-orange-400 to-yellow-300 p-[3px]">
                      <div className="h-full w-full rounded-full bg-white"></div>
                    </div>
